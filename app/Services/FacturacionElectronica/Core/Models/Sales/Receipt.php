...
use App\Services\FacturacionElectronica\Core\Models\DocumentInterface;
...
class Receipt implements DocumentInterface
{
     ...
     * @return Customer
     */
    public function getReceptor(): ?Customer
    {
        return $this->receptor;
    }

    /**
     * @param Customer $receptor
     *
     * @return Receipt
     */
    public function setReceptor(?Customer $receptor): Receipt
    {
